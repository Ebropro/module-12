...
// It does exactly two things: receive HTTP, translate result to HTTP
...
public class EnrollmentsController(IMediator mediator) : ControllerBase
{
        ...
        EnrollStudentCommand command, CancellationToken ct)
    {
        ...
        // Match() forces handling of BOTH cases — compiler error if you forget one
        ...
        return result.Match<IActionResult>(
            ...
            onFailure: error =>
            {
                ...
                // 404 = well-formed request but named resource doesn't exist
                // 409 = well-formed request but resource state forbids it
                // 400 = catch-all (shouldn't reach here — validation handles 400)
    ...
    // Query — read only, no business rule failures, returns DTO directly
