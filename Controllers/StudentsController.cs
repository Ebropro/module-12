...
// [Tags] at class level — groups all student actions under "Students" in Scalar
// Mirrors CoursesController pattern exactly
[ApiController]
[Route("api/students")]
[Tags("Students")]
    ...
    LinkGenerator linkGenerator) : ControllerBase
{
    ...
    // ── POST create student ───────────────────────────────────
    // Binds to CreateStudentRequest — Data Annotations fire automatically
    // 409 check before insert — prevents 500 on unique constraint
    [HttpPost]
